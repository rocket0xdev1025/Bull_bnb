!(function () {
  ...
  var t = {
      ...
      848: function (t, r, n) {
        function e(t, r, n, e, o, i, c) {
          ...
          a.done ? r(u) : Promise.resolve(u).then(e, o);
        }
        function o(t) {
          return function () {
            var r = this,
      ...
      453: function (t, r, n) {
        ...
        var e = n(369),
          ...
          c = n(562);
        function a(t, r) {
          return (0, e.A)(t) || (0, o.A)(t, r) || (0, i.A)(t, r) || (0, c.A)();
        }
      },
      800: function (t, r, n) {
        n.d(r, {
        ...
        function o(t, r) {
          if (t) {
            if ("string" == typeof t) return (0, e.A)(t, r);
          ...
          (function (n, e, o) {
            var i,
              ...
              d = {
                ...
                f: p.bind(t, 4),
                d: function (r, n) {
                  return (i = r), (c = 0), (a = t), (d.n = n), u;
                },
              };
            function p(n, e) {
              for (c = n, a = e, r = 0; !l && s && !o && r < f.length; r++) {
                var o,
                  i = f[r],
                  p = d.p,
                  y = i[2];
                n > 3
                  ? (o = y === e) &&
                    ((a = i[(c = i[4]) ? 5 : ((c = 3), 3)]), (i[4] = i[5] = t))
                  : i[0] <= p &&
                    ((o = n < 2 && p < i[1])
                      ? ((c = 0), (d.v = e), (d.n = i[1]))
                      : p < y &&
                        (o = n < 3 || i[0] > e || e > y) &&
                        ((i[4] = n), (i[5] = e), (d.n = y), (c = 0)));
              }
              if (o || n > 1) return u;
              throw ((l = !0), e);
            }
                    ...
                    if ((c || (o = "next"), (r = i[o]))) {
                      ...
                      1 === c && (r = i.return) && r.call(i),
                        c < 2 &&
                          ...
                          (c = 1));
                    i = t;
                  } else if ((r = (l = d.n < 0) ? a : n.call(e, d)) !== u)
                    break;
                } catch (r) {
                  (i = t), (c = 1), (a = r);
                } finally {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    var t = hostinger_reach_subscription_block_data.translations;
    document
      .querySelectorAll(".hostinger-reach-block-subscription-form")
      .forEach(function (r) {
        var n = r.querySelector(".reach-subscription-message"),
          c = r.querySelector(".reach-subscription-message__icon"),
          a = r.querySelector(".reach-subscription-message__text"),
          u = r.querySelector(".hostinger-reach-block-form-fields");
        r.addEventListener("submit", function (s) {
          s.preventDefault();
          var f = r.querySelector('button[type="submit"]'),
            l = new FormData(r),
            d = {};
                      ...
                      return i().w(function (e) {
                        for (;;)
                          switch (e.n) {
                            case 0:
                              if (
                                ((n.style.display = "flex"), r.reset(), !o.ok)
                              ) {
                                e.n = 1;
                                break;
                              }
                              (a.textContent = t.thanks),
